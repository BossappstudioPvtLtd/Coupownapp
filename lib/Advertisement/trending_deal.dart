...
class TrendingDeal extends StatefulWidget {
  ...
  @override
  _TrendingDealState createState() => _TrendingDealState();
}

class _TrendingDealState extends State<TrendingDeal> {
  ...
  final DatabaseReference _adsRef =
      FirebaseDatabase.instance.ref('advertisements/trading_deald_ad');
