...
class InstaationAdd extends StatefulWidget {
  const InstaationAdd({super.key});

  @override
  _InstaationAddState createState() => _InstaationAddState();
}

class _InstaationAddState extends State<InstaationAdd> {
  ...
  final DatabaseReference _adsRef =
      FirebaseDatabase.instance.ref('advertisements/instaltion_&_services_ad');
