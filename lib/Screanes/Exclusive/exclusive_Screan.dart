...
class ExclusiveScrean extends StatefulWidget {
  final Map<String, dynamic> deal;

  const ExclusiveScrean({super.key, required this.deal});

  @override
  _ExclusiveScreanState createState() => _ExclusiveScreanState();
}

class _ExclusiveScreanState extends State<ExclusiveScrean> {
